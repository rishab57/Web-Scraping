...
sheet = excel.active
sheet.title = 'Internshala Back-End Development Job Search'
print(excel.sheetnames)
sheet.append(['Job Profile', 'Company', 'Location', 'Stipened'])
try:
    url = "https://internshala.com/internships/backend-development-internship/"
...
excel.save('Database\Internshala\Data\IBD.xlsx')