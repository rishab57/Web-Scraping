...
sheet = excel.active
sheet.title = 'Internshala Front-End Development Job Search'
print(excel.sheetnames)
sheet.append(['Job Profile', 'Company', 'Location', 'Stipened'])
try:
    url = "https://internshala.com/internships/front-end-development-internship/"
...
excel.save('Database\Internshala\Data\IFD.xlsx')