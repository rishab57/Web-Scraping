...
sheet = excel.active
sheet.title = 'Internshala Interior Design Job Search'
print(excel.sheetnames)
sheet.append(['Job Profile', 'Company', 'Location', 'Stipened'])
try:
    url = "https://internshala.com/internships/interior-design-internship/"
...
excel.save('Database\Internshala\Data\IID.xlsx')