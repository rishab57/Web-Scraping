...
sheet = excel.active
sheet.title = 'Internshala Social Media Marketing Job Search'
print(excel.sheetnames)
sheet.append(['Job Profile', 'Company', 'Location', 'Stipened'])
try:
    url = "https://internshala.com/internships/social-media-marketing-internship/"
...
excel.save('Database\Internshala\Data\ISMM.xlsx')