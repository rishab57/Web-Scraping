...
sheet = excel.active
sheet.title = 'Shine Cloud Computing Job Search'
print(excel.sheetnames)
sheet.append(['Job Profile', 'Company', 'Location', 'Experience'])

try:

    url = "https://www.shine.com/job-search/cloud-computing-jobs?q=cloud%20computing"
...
excel.save('Database\Shine\Data\SCC.xlsx')
