...
sheet = excel.active
sheet.title = 'Shine UIUX Job Search'
print(excel.sheetnames)
sheet.append(['Job Profile', 'Company', 'Location', 'Experience'])

try:

    url = "https://www.shine.com/job-search/uiux-designer-jobs?q=Uiux%20Designer%2C%20"
...
excel.save('Database\Shine\Data\SUIUX.xlsx')
