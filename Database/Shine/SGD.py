...
sheet = excel.active
sheet.title = 'Shine Graphic Designing Job Search'
print(excel.sheetnames)
sheet.append(['Job Profile', 'Company', 'Location', 'Experience'])

try:

    url = "https://www.shine.com/job-search/graphic-designing-jobs?q=graphic%20designing"
...
excel.save('Database\Shine\Data\SGD.xlsx')
