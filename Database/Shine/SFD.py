...
sheet = excel.active
sheet.title = 'Shine Front-End Developer Job Search'
print(excel.sheetnames)
sheet.append(['Job Profile', 'Company', 'Location', 'Experience'])

try:

    url = "https://www.shine.com/job-search/frontend-developer-jobs?q=frontend%20developer"
...
excel.save('Database\Shine\Data\SFD.xlsx')
