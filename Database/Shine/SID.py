...
sheet = excel.active
sheet.title = 'Shine Interior Designing Job Search'
print(excel.sheetnames)
sheet.append(['Job Profile', 'Company', 'Location', 'Experience'])

try:

    url = "https://www.shine.com/job-search/interior-designing-jobs?q=interior%20designing"
...
excel.save('Database\Shine\Data\SID.xlsx')
