...
sheet = excel.active
sheet.title = 'Shine Web Development Search'
print(excel.sheetnames)
sheet.append(['Job Profile', 'Company', 'Location', 'Experience'])

try:

    url = "https://www.shine.com/job-search/web-development-jobs?q=Web%20Development%2C%20"
...
excel.save('Database\Shine\Data\SWD.xlsx')
