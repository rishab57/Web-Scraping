...
sheet = excel.active
sheet.title = 'Shine Social Media Marketing Job Search'
print(excel.sheetnames)
sheet.append(['Job Profile', 'Company', 'Location', 'Experience'])

try:

    url = "https://www.shine.com/job-search/social-media-jobs?q=social%20media"
...
excel.save('Database\Shine\Data\SSMM.xlsx')
